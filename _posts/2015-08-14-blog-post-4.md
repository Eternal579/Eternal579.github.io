...
- p4-16 has a more comprehensive documentation avaliable for reference, you can find every structure [here](http://eternal579.github.io/files/PUBLIC_Tofino-Native-Arch.pdf).
...
- use python script, API is hidden [here](http://eternal579.github.io/files/p4-control-API.zip)
